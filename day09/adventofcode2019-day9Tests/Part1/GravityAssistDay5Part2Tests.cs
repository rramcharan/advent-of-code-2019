...
{
    [TestClass()]
    public class GravityAssistDay5Part2Tests
    {
        #region Examples
        ...
        public void Input_Test01()
        {
            ...
            // Act
            var result = IntCodeComputer.ProcessWithUserInput(input, new long[] { 1 });
        ...
        public void Output_Test01()
        {
            ...
            result.Output.ShouldBe(new List<long> { 4 });
        }
        ...
        public void Output_Test02()
        {
            ...
            result.Output.ShouldBe(new List<long> { 0 });
        }
        ...
        public void JumpIfTrue_NoJump_Test01()
        {
            ...
            result.Output.ShouldBe(new List<long> { 1105 });
        }
        ...
        public void JumpIfTrue_Jump_Test01()
        {
            ...
            result.Output.ShouldBe(new List<long> { 200 });
        }
        ...
        public void JumpIfFalse_Jump_Test01()
        {
            ...
            // Arrange
            Assert.AreEqual(8, result.Codes.Keys.Count, "unexpected number of elements");
            result.Output.ShouldBe(new List<long> { 99 });
        }
        ...
        {// Arrange
            ...
            // Act
            var result = IntCodeComputer.ProcessWithUserInput(input, new long[] { 8 });

            // Arrange
            result.Output.ShouldBe(new List<long> { 1 });
        }
        ...
        {// Arrange
            ...
            // Act
            var result = IntCodeComputer.ProcessWithUserInput(input, new long[] { 4 });
        ...
        {// Arrange
            ...
            // Act
            var result = IntCodeComputer.ProcessWithUserInput(input, new long[] { 6 });
        ...
        {// Arrange
            ...
            // Act
            var result = IntCodeComputer.ProcessWithUserInput(input, new long[] { 16 });
        ...
        {// Arrange
            ...
            // Act
            var result = IntCodeComputer.ProcessWithUserInput(input, new long[] { 7 });
        ...
        {// Arrange
            ...
            // Act
            var result = IntCodeComputer.ProcessWithUserInput(input, new long[] { 9 });
        ...
        {// Arrange
            ...
            // Act
            var result = IntCodeComputer.ProcessWithUserInput(input, new long[] { 0 });
        ...
        {// Arrange
            ...
            // Act
            var result = IntCodeComputer.ProcessWithUserInput(input, new long[] { 2 });
        ...
        {// Arrange
            ...
            // Act
            var result = IntCodeComputer.ProcessWithUserInput(input, new long[] { 100 });
        ...
        {// Arrange
            ...
            // Arrange
            result.Output.ShouldBe(new List<long> { 999 });
        }
        ...
        {// Arrange
            ...
            // Arrange
            result.Output.ShouldBe(new List<long> { 1000 });
        }
        ...
        {// Arrange
            ...
            // Arrange
            result.Output.ShouldBe(new List<long> { 1001 });
        }
        ...
        public void Puzzle()
        {
            ...
            // Arrange
            result.Output.ShouldBe(new List<long> { 0, 0, 0, 0, 0, 0, 0, 0, 0, 16489636 });
        }
        ...
        {// Arrange
            ...
            // Act
            var result = IntCodeComputer.ProcessWithUserInput(input, new long[] { 5 });

            // Arrange
            result.Output.ShouldBe(new List<long> { 9386583 });
        }
