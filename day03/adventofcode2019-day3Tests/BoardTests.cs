...
...........";
        ...
        [TestMethod()]
        public void TraversePath_Examples_Test01()
        {
            // Arrange
            var board = new Board();
            ...
            // Assert
            Assert.AreEqual(15, endPointWire1.StepsToClosestConnector);
            Assert.AreEqual(15, endPointWire2.StepsToClosestConnector);
            Assert.AreEqual(30, board.MinimalStepsToIntersection);
            var expectedMap = @"
...........
.-------...
.-.....-...
...
...........";
        ...
        #region Examples Part 2

        [TestMethod()]
        public void TraversePath_ExamplesPart2_Test01()
        {
            // Arrange
            var board = new Board();
        ...
        [TestMethod()]
        public void TraversePath_ExamplesPart2_Test02()
        {
            // Arrange
            var board = new Board();
            ...
            // Assert
            Assert.AreEqual(610, board.MinimalStepsToIntersection);
        }

        [TestMethod()]
        public void TraversePath_ExamplesPart2_Test03()
        {
            // Arrange
            var board = new Board();

            // Act
            board.Wire("R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51");
            board.Wire("U98,R91,D20,R16,D67,R40,U7,R15,U6,R7");

            // Assert
            Assert.AreEqual(410, board.MinimalStepsToIntersection);
        }

        #endregion

        #region Puzzle Part 2 input

        [TestMethod()]
        public void Solve_Puzzle_Part2()
        {
            // Arrange
            var board = new Board();
            ...
            // Assert
            Assert.AreEqual(5672, board.MinimalStepsToIntersection);
        }
