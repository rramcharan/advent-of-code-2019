...
namespace adventofcode2019_day11.Day11Part1.PaintingRobot.Tests
{
    ...
    public class PuzzleDay11Part1
    {
        ...
        {// Arrange
            ...
            // Act
            var printer = EmergencyHullPaintingRobot.Process(input);

            // Arrange
            printer.Computer.IsHalted.ShouldBeTrue();
            printer.Computer.Output.Count.ShouldBe(0);
            printer.NbrOfPanelsPainted.ShouldBe(1932);
